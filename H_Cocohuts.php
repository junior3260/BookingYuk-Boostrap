...
<div class="container">
    <div class="jumbotron">
        <h1 style="text-align:center">HOTEL COCOHUTS</h1><hr>
        ...
        <div class="menu-contact">
	            <p>CocoHuts Inn Karimun Jawa salah satu tempat terbaik untuk tinggal, makan dan menikmati pemandangan yang menakjubkan di Pulau Karimun Jawa. penginapan ini mempunyai fasilitas Internet yang cukup cepat. Pemandangan dari restoran menakjubkan. Tidak semua fasilitas bekerja, tapi pemilik besar untuk membantu Anda menemukan solusi. Tempat tidur baru dan benar-benar nyaman. Di restoran mereka membuat pizza terbaik yang pernah saya makan di Asia. Kami memiliki waktu yang besar dan itu benar-benar layak harga.</p>
        </div>
    </div>
	...
	<div class="panel panel-default panels-color menu-conten">
	  	<div class="panel-body">
			...
			<div class="row">
		        ...
		        <div class="col-sm-6 col-md-4 col-lg-6">
		            <h2>Bungalow with Sea View</h2><hr>
		           		 <img src="images/Cocohuts/f5.Cocohuts.jpg" class="img-thumbnail" alt="Bungalow with Sea View" width="250" height="350" style="float:left;">
		           		 <div class="space-hotel col-sm-6 col-md-4 col-lg-6"> 
		        ...
		        <div class="clearfix visible-sm-block"></div>
		        <div class="col-sm-6 col-md-4 col-lg-6">
		            <h2>Deluxe Bungalow with Sea View</h2><hr>
		           		 <img src="images/Cocohuts/f6.Cocohuts.jpg" class="img-thumbnail" alt="Deluxe Bungalow with Sea View" width="250" height="350" style="float:left;">
						<div class="space-hotel col-sm-6 col-md-4 col-lg-6"> 
			...
			<div class="row">
		        <div class="col-sm-6 col-md-4 col-lg-6">
		            <h2>Kamar Tidur</h2><hr>
		            	<img src="images/Cocohuts/f1.Cocohuts.jpg" class="img-thumbnail" alt="Kamar Tidur" width="200" height="270" style="float:left;">
		        </div>
		        <div class="clearfix visible-sm-block"></div>
		        <div class="col-sm-6 col-md-4 col-lg-6">
