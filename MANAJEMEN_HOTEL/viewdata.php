...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="#"><use xlink:href="#stroked-calendar"/></svg><svg class="glyph stroked camera "><use xlink:href="#stroked-camera"/></svg>Gallery</a></li>
			<li class="parent ">
				<a href="#">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body" >
							<h4>Data Hotel
								<a class="tambahhotel" href="tambah.php">Tambah Hotel</a>
							</h4><br/>
							<table border="1" class="datahotel">
								<tr>
									<th>No</th>
									<th>Nama Hotel</th>
									<th>Keterangan</th>
								...
								<?php
								$sql = "select * from manajement_hotel";
								...
								while ($row = mysqli_fetch_array($result)) {
									...
									<tr>
										<td width="60px" align="center"><?php echo $no;?></td>
										<td width="200px"><?php echo $row['judul'];?></td>
										<td><?php echo $row['keterangan'];?></td>
										<td width="200px"><img style="margin:10px 0;" width="200px" src="../gambar/<?php echo $row['file'];?>"></td>
										

										<td class="aksi" align="center">
											<a class="tombolubah" href="ubah.php?id=<?php echo $row['id'];?>">Ubah</a> &nbsp
											<a class="tombolhapus" href="hapus.php?file=<?php echo $row['file'];?>">Hapus</a>	
										</td>
									</tr>
